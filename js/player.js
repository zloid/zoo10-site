...
function drawAllNewButtons (containerForNewUIAudioElement) {
    ...
    newBtnStop.id = 'stop';
    newBtnStop.className = 'btn btn-danger';
    newBtnStop.innerHTML = 'STOP';
    //play
    let newBtnPlay = document.createElement('button');
    newBtnPlay.id = 'play';
    // newBtnPlay.classList.add = 'btn';
    newBtnPlay.className = 'btn btn-success';
    // newBtnPlay.classList.add = 'btn-outline-secondary';
    newBtnPlay.innerHTML = 'PLAY';
    //back
    let newBtnBack = document.createElement('button');
    newBtnBack.id = 'back';
    newBtnBack.className = 'btn btn-warning';
    // newBtnBack.classList = 'btn';
