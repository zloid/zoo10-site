...
<html>
 <head>
  <meta charset="utf-8">
  <title>zoo10-super-zloid-adminka.php</title>
 ...
 <div style="width: 1200px;
   ...
   <li><a href="/"><h3>http://zoo10.loc/zoo10-super-zloid-adminka.php/</h3></a></li>
...
<textarea name="fon_body" rows="1" cols="10">zoo10_pattern.png</textarea><br /><br />
...
<textarea name="fon_shpki" rows="1" cols="20">hdr_zoo10_4.jpg</textarea><br /><br />
...
<head>
   ...
   <link rel="stylesheet" href="css/style_5.css" media="screen">
...
<div class="wrapper">
	...
	<div class="audio-player">
		<h1>Салат внутри</h1>
		<img class="cover" src="patterns/kus_s_derm_cover.jpg" alt="">
		<audio id="audio-player" src="Zoo10_salat_vnutri.mp3" type="audio/mp3" controls="controls"></audio>
	</div>
...
<div class="footer">
	<p>© <script type=\'text/javascript\'>dt = new Date();document.write(dt.getFullYear());</script>  <u><strong><a href="http://zoo10.zloid.ru">zoo10.zloid.ru</a></strong></u> – Сайт посвящается JC и группе Zoo10 | Все права принадлежат правОобладателям :) </strong></p>
</div><!-- .footer -->
...
.footer {
	...
	padding: 8px;
    text-align: center;
    box-shadow: 0 0 10px rgba(148, 160, 191, 0.5);
    border-radius: 29px;
    font-size: 14px;
	font-size: 17px;
    font-family: cursive;
